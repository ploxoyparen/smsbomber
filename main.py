...
def step_buy(call):
	if call.data == 'buying':
		link_pay = 'https://oplata.qiwi.com/create?publicKey='+config.QIWI_PUBLICKEY+'&amount=' + str(config.price) + '&comment='+str(random.randint(11111,99999))+'-EyeGod'
		markup = types.InlineKeyboardMarkup()
		button1 = types.InlineKeyboardButton('Оплатить', url=link_pay)
		markup.add(button1)
